import './SunBurst.css';
import { groupBy, map, each } from 'lodash';
import { formatL1, formatType, formatScripture } from '../constants';
...
export function renderSunBurst(content) {
	// Use d3.text and d3.csv.parseRows so that we do not need to have a header
	// row, and can receive the csv as an array of arrays.
	let json = buildStudyHierarchy(content);
	createVisualization(json);
}

function buildStudyHierarchy(content) {
	let heirarch = {
		name: 'root',
		children: []
	};
